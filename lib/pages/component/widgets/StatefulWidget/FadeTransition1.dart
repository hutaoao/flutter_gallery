...
class HtFadeTransition1 extends StatefulWidget {
  const HtFadeTransition1({super.key});

  @override
  State<StatefulWidget> createState() => _HtFadeTransition1State();
}

class _HtFadeTransition1State extends State<HtFadeTransition1> with SingleTickerProviderStateMixin {
